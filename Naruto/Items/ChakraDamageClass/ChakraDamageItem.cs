...
namespace ChakraMod.Items.ChakraDamageClass
{
    // This class handles everything for our custom damage class
    // Any class that we wish to be using our custom damage class will derive from this class, instead of ModItem
    public abstract class ChakraDamageItem : ModItem
    {
        ...
        public override void GetWeaponDamage(Player player, ref int damage)
        {
            ...
            damage = (int)(damage * ChakraDamagePlayer.ModPlayer(player).chakraDamage + 5E-06f);
        }

        public override void GetWeaponKnockback(Player player, ref float knockback)
        {
            // Adds knockback bonuses
            knockback = knockback + ChakraDamagePlayer.ModPlayer(player).chakraKnockback;
        }

        public override void GetWeaponCrit(Player player, ref int crit)
        {
            // Adds crit bonuses
            crit = crit + ChakraDamagePlayer.ModPlayer(player).chakraCrit;
        }
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            if (tt != null)
            {
                ...
                tt.text = damageValue + " chakra " + damageWord;
            }
        }
    }
}